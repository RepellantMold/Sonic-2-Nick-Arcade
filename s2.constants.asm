...
spec__First:	equ $D0
sfx_Waterfall:	equ ((ptr_sndD0-SoundD0Index)/4)+spec__First
spec__Last:	equ ((ptr_specend-SoundD0Index-4)/4)+spec__First

flg__First:	equ $E0
bgm_Fade:	equ ((ptr_flgE0-CommandIndex)/4)+flg__First
sfx_Sega:	equ ((ptr_flgE1-CommandIndex)/4)+flg__First
bgm_Speedup:	equ ((ptr_flgE2-CommandIndex)/4)+flg__First
bgm_Slowdown:	equ ((ptr_flgE3-CommandIndex)/4)+flg__First
bgm_Stop:	equ ((ptr_flgE4-CommandIndex)/4)+flg__First
flg__Last:	equ ((ptr_flgend-CommandIndex-4)/4)+flg__First
...
MusicToPlay:			equ	$A			; when Genesis wants to play "normal" sound, it writes it here
SFXToPlay:			equ	$B			; when Genesis wants to play "special" sound, it writes it here
